export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxb747f7e2f2f0353a",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "9ef6412c52bb2dfa45e122ca0412afea
",
   ...
   *    id: "  IFWDiAAaOf1gdVAJj7bBiYunrKosK1E7cKWrGAzjR48",
   *    // 你想对他发送的模板消息的模板ID
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2003", "date": "05-01"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "老公", "year": "2001", "date": "11-04"},
        {"type": "节日", "name": "被搭讪纪念日", "year": "2022", "date": "04-13"},
      ],
